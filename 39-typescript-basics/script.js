...
console.log("Your username is ".concat(username, " and your level is ").concat(level, "!"));
...
var knowsTypeScript = false;
// knowsTypeScript = 42;  // Type 'number' is not assignable to type 'boolean'
/**
 * Arrays
 */
var todos = ["Learn JS", "Learn TS"]; // `todos` will be of type `string[]`
...
var nameOrNumber = "kids don't try this at home";
nameOrNumber = -1;
// nameOrNumber = false;
setTimeout(function () {
    console.log("🧑🏽‍💻");
